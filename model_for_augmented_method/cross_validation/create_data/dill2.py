...
test_singers = [2, 12, 22, 32, 42, 52, 62, 72, 82, 92]  # modify
val_singers = [3, 13, 23, 33, 43, 53, 63, 73, 83, 93]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_2.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_2.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_2.dill', 'wb')
