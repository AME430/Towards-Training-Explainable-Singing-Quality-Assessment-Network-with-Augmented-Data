...
test_singers = [7, 17, 27, 37, 47, 57, 67, 77, 87, 97]  # modify
val_singers = [8, 18, 28, 38, 48, 58, 68, 78, 88, 98]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_7.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_7.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_7.dill', 'wb')
