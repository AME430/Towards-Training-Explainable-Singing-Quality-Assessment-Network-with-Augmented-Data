...
test_singers = [6, 16, 26, 36, 46, 56, 66, 76, 86, 96]  # modify
val_singers = [7, 17, 27, 37, 47, 57, 67, 77, 87, 97]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_6.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_6.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_6.dill', 'wb')
