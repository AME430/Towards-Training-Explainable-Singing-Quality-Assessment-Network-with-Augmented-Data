...
def evaluate_classification(targets, predictions):
    ...
    predictions[predictions > 1] = 1
    pearson = pearsoncorr(targets.flatten(), predictions.flatten()) # Pearson 相关性
...
if __name__ == '__main__':
    ...
    configure('D:/nuspro/logg/Chromagram_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1', flush_secs=2)
    ...
    train_dataset = SpectralDataset('D:/dill_data/test/train_1.dill', 0, rep_params)
    ...
    test_dataset = SpectralDataset('D:/dill_data/test/test_1.dill', 0, rep_params)
    ...
    valid_dataset = SpectralDataset('D:/dill_data/test/val_1.dill', 0, rep_params)
    ...
    for epoch in range(num_epochs):
        ...
        if val_pearson > best_val_corr:
            ...
            torch.save(model, 'D:/nuspro/model/model_SpectralCRNN_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1_chro')
