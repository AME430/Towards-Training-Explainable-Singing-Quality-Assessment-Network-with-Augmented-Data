...
def evaluate_classification(targets, predictions):
    ...
    # print("R2 = ", r2)
    return pearson_corre


# Configure tensorboard logger
configure('runs/CQT_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1', flush_secs=2)
...
for epoch in range(num_epochs):
    ...
    train_pearson = evaluate_classification(np.array(all_targets), np.array(all_predictions))
    ...
    val_pearson = evaluate_classification(np.array(all_targets), np.array(all_predictions))
    ...
    if val_pearson > best_val:
        ...
        print('save model: ')
        torch.save(model, './models_CQT/model_SpectralCRNN_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1_CQT_v2')
