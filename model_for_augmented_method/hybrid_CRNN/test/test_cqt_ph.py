...
train_dataset = SpectralDataset('/hpctmp/e0572686/dilldata_400_new/train_1.dill', 0, rep_params)
train_dataloader = SpectralDataLoader(train_dataset, batch_size = 5, num_workers = 4, shuffle = False)

test_dataset = SpectralDataset('/hpctmp/e0572686/dilldata_400_new/test_1.dill', 0, rep_params)
test_dataloader = SpectralDataLoader(test_dataset, batch_size = 5, num_workers = 1, shuffle = False)

valid_dataset = SpectralDataset('/hpctmp/e0572686/dilldata_400_new/val_1.dill', 0, rep_params)
