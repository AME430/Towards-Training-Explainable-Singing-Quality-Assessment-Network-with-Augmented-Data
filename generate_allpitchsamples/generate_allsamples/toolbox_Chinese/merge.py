...
def merge_files(path,song_name):
    path_read_folder = path + os.sep + 'badsample_changepitch' + os.sep + song_name + os.sep + 'notescut'
    path_write_wav_file = path + os.sep + 'badsample_changepitch' + os.sep + song_name + os.sep + 'small.wav'
    ...
    song.export(path + os.sep + 'badsample_changepitch' + os.sep + song_name + os.sep + 'result.wav', "wav")
