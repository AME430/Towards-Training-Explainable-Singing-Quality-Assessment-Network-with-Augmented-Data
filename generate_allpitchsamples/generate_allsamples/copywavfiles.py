...
for singer_name in singer_names1:
    ...
    for song_name in Vox_list:
        old_file_ori = second_path + os.sep + song_name + '.wav'
        new_file_path1= 'C:/DataBaker_songs/total_songs_exp3/' + singer_name + '_' + song_name +'.wav'
        shutil.copyfile(old_file_ori,new_file_path1)

        old_file_ori = ori_path1 + os.sep + singer_name + os.sep + 'badsample_changepitch' + os.sep + song_name + os.sep + 'result.wav'
        new_file_path1= 'C:/DataBaker_songs/total_songs_exp3/' + singer_name + '_' + song_name + '_pshift150' +'.wav'
        shutil.copyfile(old_file_ori,new_file_path1)
...
for singer_name in singer_names:
    ...
    for song_name in song_names:
        old_file_ori = second_path + os.sep + song_name + os.sep + 'song.wav'
        new_file_path1= 'C:/DataBaker_songs/total_songs_exp3/' + singer_name + '_' + song_name +'.wav'
        shutil.copyfile(old_file_ori,new_file_path1)

        old_file_ori = second_path + os.sep + song_name + os.sep + 'result.wav'
        new_file_path1= 'C:/DataBaker_songs/total_songs_exp3/' + singer_name + '_' + song_name + '_pshift150' +'.wav'
        shutil.copyfile(old_file_ori,new_file_path1)