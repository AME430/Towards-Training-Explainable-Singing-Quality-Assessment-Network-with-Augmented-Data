...
for singer_name in singer_names1:
    ...
    for song_name in Vox_list:
        old_file = ori_path1 + os.sep +'pitch_folder_exp1' + os.sep +  singer_name + '_' + song_name + '.pitch'
        new_file = 'C:/DataBaker_songs/pitch_folder_exp3/' + singer_name + '_' + song_name + '.pitch'
