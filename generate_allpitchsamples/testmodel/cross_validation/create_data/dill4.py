...
test_singers = [4, 14, 24, 34, 44, 54, 64, 74, 84, 94]  # modify
val_singers = [5, 15, 25, 35, 45, 55, 65, 75, 85, 95]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_4.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_4.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_4.dill', 'wb')
