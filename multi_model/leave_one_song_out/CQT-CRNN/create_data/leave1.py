...
songs_train = ['_let_it_go','_stay_rihanna','_when_i_was_your_man']
songs_leave = ['_cups_pitch_perfect']
...
if __name__=='__main__':
    ...
    train_dill = open(cv1_folder+os.sep+'train_leave_1.dill','wb')
    test_dill = open(cv1_folder+os.sep+'test_leave_1.dill','wb')
    val_dill = open(cv1_folder+os.sep+'val_leave_1.dill','wb')
