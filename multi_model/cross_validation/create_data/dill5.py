...
test_singers = [5, 15, 25, 35, 45, 55, 65, 75, 85, 95]  # modify
val_singers = [6, 16, 26, 36, 46, 56, 66, 76, 86, 96]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_5.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_5.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_5.dill', 'wb')
