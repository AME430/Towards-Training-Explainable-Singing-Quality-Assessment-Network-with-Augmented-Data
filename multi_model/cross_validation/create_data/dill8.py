...
test_singers = [8, 18, 28, 38, 48, 58, 68, 78, 88, 98]  # modify
val_singers = [9, 19, 29, 39, 49, 59, 69, 79, 89, 99]
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_8.dill', 'wb')  # modify
    test_dill = open(cv1_folder + os.sep + 'test_8.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_8.dill', 'wb')
