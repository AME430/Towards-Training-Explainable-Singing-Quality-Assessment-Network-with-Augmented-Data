...
songs_train = ['_cups_pitch_perfect', '_stay_rihanna', '_when_i_was_your_man']
songs_leave = ['_let_it_go']
...
if __name__ == '__main__':
    ...
    train_dill = open(cv1_folder + os.sep + 'train_leave_2.dill', 'wb')
    test_dill = open(cv1_folder + os.sep + 'test_leave_2.dill', 'wb')
    val_dill = open(cv1_folder + os.sep + 'val_leave_2.dill', 'wb')
