...
model_path = './models_hybrid/model_SpectralCRNN_reg_lr0.0001_big_ELU_Adam_noteacc_bws-1to1_CQT_ph_corr' # modify
...
np.savetxt('./tsne_CQT_ph/feature_train.txt', feature_array_train)
np.savetxt('./tsne_CQT_ph/target_train.txt', target_array_train)
# np.savetxt('./tsne_CQT_ph/feature_val.txt', feature_array_val)
# np.savetxt('./tsne_CQT_ph/target_val.txt', target_array_val)
np.savetxt('./tsne_CQT_ph/feature_test.txt', feature_array_test)
np.savetxt('./tsne_CQT_ph/target_test.txt', target_array_test)
